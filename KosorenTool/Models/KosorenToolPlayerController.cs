...
namespace KosorenTool.Models
{
    public class KosorenToolPlayerController : IInitializable, IDisposable, ICutScoreBufferDidFinishReceiver
    {
        ...
        public static readonly Vector3 LeftPosition = new Vector3(0, 2f, 4.5f);
        ...
        public KosorenToolPlayerController(DiContainer container)
        {
            ...
            try
            {
                ...
                this._songController = container.Resolve<SongController>();
            }
            catch (Exception e)
            {
                Plugin.Log.Error(e);
        ...
        public void Initialize()
        {
            ...
            if (PluginConfig.Instance.ScoreBelowPause)
            {
        ...
        public void HandleCutScoreBufferDidFinish(CutScoreBuffer csb)
        {
            ...
            if (PluginConfig.Instance.ScoreBelowPause && (csb.beforeCutScore + csb.afterCutScore + csb.centerDistanceCutScore) <= PluginConfig.Instance.SingleNotesScore)
            {
